...
def gen_rotated_images(images, images_groundtruth, save=False):
    """
    Generates the rotated images from the original ones. Saves them on the disk if save is True.

    :param images: array of images
    :param images_groundtruth: array of groundtruth images
    :param save: set it to True if the images should be saved on disk
    """
...
if __name__ == "__main__":
    ...
    gen_rotated_images(images, images_groundtruth, save=True)
