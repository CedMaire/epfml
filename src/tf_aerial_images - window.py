...
def extract_data(filename, num_images, border):
...
if __name__ == '__main__':
    ...
    # Extract it into numpy arrays.
    train_data = extract_data(train_data_filename, TRAINING_SIZE, 28)
    train_labels = extract_labels(train_labels_filename, TRAINING_SIZE)
...
"""
    ...
    if not should_load_model:
        ...
        road_model = Sequential()
        road_model.add(Conv2D(32, kernel_size=(3, 3),activation='linear',input_shape=(72,72,3),padding='same'))
        road_model.add(LeakyReLU(alpha=0.1))
        road_model.add(MaxPooling2D((2, 2),padding='same'))
        ...
        road_model.save("road_model_dropout_from32to128batch64Window72.h5py")
